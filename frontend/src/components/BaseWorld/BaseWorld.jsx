...
import { SpaceHolidaysSky, SpaceHolidaysGround, SpaceHolidaysFront } from './holidays/SpaceHolidays';
  ...
  return (
    <div className="base-world">
      ...
      >
        ...
        {isSpace && <SpaceHolidaysSky holiday={holiday} />}
        ...
        {isSpace && <SpaceHolidaysGround holiday={holiday} />}
        ...
        {isSpace && <SpaceHolidaysFront holiday={holiday} />}
