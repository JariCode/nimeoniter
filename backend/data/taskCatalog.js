...
const TASK_CATALOG = [
  ...
  { key: 'tv_series',        icon: '📺', name: 'Watch TV-series', xp: 10, resources: { food: 1 } },
  { key: 'documentary', icon: '📽️', name: 'Watch a documentary', xp: 10, resources: { wood: 1, food: 1 } },
  { key: 'sports',     icon: '🏀', name: 'Watch sports',        xp: 10, resources: { wood: 1, food: 1 } },
